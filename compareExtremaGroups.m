clear; close all;
 ...
 load('/Users/samirsherlekar/Desktop/emg/Data/extremaMatrixOld.mat')
% load('/Users/samirsherlekar/Desktop/emg/Data/extremaMatrixOldAllMuscles.mat')
...
[min_M2, max_M2, ratio_M2] = getExtremaMatrix(extremaMatrixOld);
...
plotExtremaEmgVoltages(n_muscles,muscleOrder,max_M,10,'Max EMG Voltages for Young Subjects : YOUNG MUSCLES' ,[3e-6 2e-4])
plotExtremaEmgVoltages(n_muscles,muscleOrder,max_M2,10,'Max EMG Voltages for Old Subjects : YOUNG MUSCLES', [3e-6 2e-4])
